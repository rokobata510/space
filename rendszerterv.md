...
## 6. Fizikai környezet
  ### Vásárolt softwarekomponensek és külső rendszerek
        Nem igényel vásárolt szoftverkomponenst.
        
        
  ### Hardver topológia
     Az oldal gépen fut tökéletesen hiba nélkül.
...
### 5.1 Rendszerszereplők
        A rendszer internet hiányában is működtethető importálás
    esemény megtörténte melett. Jogosultsági körben
    a felhasználók között nem teszünk különbséget, mert
    a rendszer elvégez önmagától mindent (pl. törlés) amit
    az admin felhasználó tidna csinálni.
    
    
### 5.2 Menühierarchiák
        Az oldalunk céja az egyszerűség és a lényegre törés
    volt így nem helyeztünk el menü rendszert rajta. A menü rendszer
    csupán terelné a felhasználó figyelmét ebben az esetben szóval egy fölöslegesnek
    mondható rendszeri eszkök lett vona.A szoftver egy nagyon egyszerű menürendszert tartalmaz.


## 6. Fizikai környezet
  ### Vásárolt softwarekomponensek és külső rendszerek
        Nem igényel vásárolt szoftverkomponenst,
     mert web böngészőből futtatni tudja a felhasználó.
        
        
  ### Hardver topológia
        Az oldal gépen webböngésző segítésgével futtatható
     tökéletesen hiba nélkül.
     
     
  ### Fizikai alrendszerek
        Egy bőngésző amely az elektronikai eszközön fut
     abba lehetséges az oldal futtatása és megtekintése.
